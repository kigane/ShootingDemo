...
{
    //脚本模板所在的目录
    private const string MY_SCRIPT_DEFAULT = "Assets/Editor/ScriptTemplates/MonoTemplate.cs.txt";
    private const string MY_SIMPLE_SCRIPT = "Assets/Editor/ScriptTemplates/SimpleTemplate.cs.txt";
    private const string COMMAND_SCRIPT = "Assets/Editor/ScriptTemplates/Command.cs.txt";
    private const string CONTROLLER_SCRIPT = "Assets/Editor/ScriptTemplates/Controller.cs.txt";

    [MenuItem("Assets/A MonoScript", false, 80)]
    public static void CreateMyScript()
    {
        ...
        ProjectWindowUtil.StartNameEditingIfProjectWindowExists(
            ...
            null,
            MY_SCRIPT_DEFAULT); // 模板文件路径
    }

    [MenuItem("Assets/A SimpleScript", false, 80)]
    public static void CreateSimpleScript()
    {
        ...
        ProjectWindowUtil.StartNameEditingIfProjectWindowExists(
            ...
            null,
            MY_SIMPLE_SCRIPT); // 模板文件路径
    }

    [MenuItem("Assets/A Command", false, 80)]
    ...
    [MenuItem("Assets/A Controller", false, 80)]
    public static void CreateControllerScript()
    {
        ...
        ProjectWindowUtil.StartNameEditingIfProjectWindowExists(
            0,
            ScriptableObject.CreateInstance<MyDoCreateScriptAsset>(), // 回调，处理模板中的宏
            locationPath + "/Controller.cs", // 新建文件的路径
            null,
            CONTROLLER_SCRIPT); // 模板文件路径
    }
